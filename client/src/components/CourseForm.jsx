...
const CourseForm = () => {
  ...
  return (
    <form className="flex flex-col md:flex-row bg-gray-00" onSubmit={handleSubmit} style={{ minHeight: '100vh', width: '100%' }}>
      <div className="md:w-1/2 p-10 pt-3">
        ...
        <div className="mt-4 px-16">
          <div className='overflow-x-hidden overflow-y-auto' style={{ border: '1px solid #94a3b8', height: '35vh' }}>
            ...
            <div className='flex'>
              ...
              <button onClick={handleAddChapter} className="w-full h-11 bg-indigo-500   text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 md:text-sm p-0 pt-0 " style={{ borderRadius: '0', color: 'white' }}>
  ...
  <button className='flex items-center m-0.5 p-0 ml-8 bg-indigo-500 mt-0.5 p-0.5 text-white  ' style={{fontSize:'1rem',borderRadius:'0%'}}  >
