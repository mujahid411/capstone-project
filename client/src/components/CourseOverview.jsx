...
const CourseOverview = () => {
  ...
  const makePayment = async () => {
    const stripe = await loadStripe(
      "pk_test_51OMlc3SC1ryoYNe3cIVyBbPxpmMWCQVN7gwG1JhinGVis7px23qRr0H10OFs7aro0GU1XkuDsWJqM72qwOCj3v7E00b9WT4bEl"
    );
    const body = {
      products: courseData,
    };
    ...
    const response = await axios.post(
      "/api/courses/create-checkout-session",
      body,
      {
        headers: headers,
      }
  ...
  return (
    <>
      ...
      <section
        className="w-full px-2 py-0 grid grid-cols-1 md:grid-cols-2  gap-4 max-w-8xl mx-auto pb-8 "
        style={{
      ...
      >
        ...
        <div
          className=" p-1 sm:mt-10 text-gray-600 text-base "
          style={{ color: "" }}
        >
          <h3
          ...
          <p
            className="text-base   my-4  max-w-2xl "
            style={{ textAlign: "initial" }}
          >
            Description: {courseData.courseDescription} Lorem, ipsum dolor sit
            amet consectetur adipisicing elit. Provident quasi dolores hic,
            earum excepturi cum libero ipsum quaerat culpa velit, repellat eum
            temporibus maxime alias modi ducimus obcaecati amet! Rem commodi
            obcaecati illum ullam nesciunt voluptatem fugiat totam quis iure!
            Veritatis tempore aspernatur debitis, enim est excepturi culpa ipsam
            itaque? lorem100 Lorem ipsum dolor sit amet consectetur, adipisicing
          ...
          <p className="text-base   my-4 " style={{ textAlign: "initial" }}>
            <span>Author: {courseData.teacherName || "traversy media"}</span>
          </p>
