...
const SingleCourse = () => {
    return (
        ...
        //     <a className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-x-auto hover:shadow-lg transition dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]" href="#" >
        //         <div className="relative pt-[50%] sm:pt-[60%] lg:pt-[65%] rounded-t-xl overflow-x-auto">
        ...
        {Array.from({ length: 5 }).map((_, index) => (
          <div key={index} className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-x-auto hover:shadow-lg transition dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
            <div className="relative pt-[50%] sm:pt-[60%] lg:pt-[65%] rounded-t-xl overflow-x-auto">
              <img
