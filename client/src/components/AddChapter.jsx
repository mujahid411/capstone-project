                ...
                <div className="flex min-h-full flex-1 flex-col justify-center px-3 py-3 lg:px-8" id='flex-container' >
                    ...
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm" style={{ fontSize: '1.8rem' }}>
                        <form className="space-y-0" onSubmit={handleSubmit} >
                            ...
                            </div> : videoValue ? <div className='w-full h-72' style={{ border: '1px solid grey', marginTop: '0', borderTop: '0px' }}><div role="status" className="flex items-center justify-center h-full max-w-sm bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700">
